...
import '../../core/widgets/user_qr_code_widget.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  static Map<String, String> get _categoryPromoUrls => {
    'personal_loan': AppAssets.personalLoanPromo,
    'credit_card': AppAssets.creditCardPromo,
    'insurance': AppAssets.insurancePromo,
  };
  ...
  Future<void> _loadWallet() async {
    ...
    if (!mounted) return;
    await context.read<WalletController>().refreshWalletSummary(mobile);
  }
        ...
        children: [
          ...
          Expanded(
            child: _DashboardBodyBuilder(
              ...
              carouselPaths: AppAssets.carousel,
              kycBannerPath: AppAssets.kycBanner,
              categoryPromoPaths: _categoryPromoUrls,
              balanceStr: wallet.balanceStr,
              earningStr: wallet.earningStr,
            ),
          ),
        ],
      ),
  ...
  static Widget _copyOfBuildBalanceCard(Color primaryDark, Color primary, Color accentOrange, Color yellow, VoidCallback? onAddLeadTap, {VoidCallback? onBalanceCardTap, String balanceStr = '0.00', String earningStr = '0.00'}) {
    final content = Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: primary.withValues(alpha: 0.3), blurRadius: 20, offset: const Offset(0, 10), spreadRadius: 2)],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Container(
                ...
                height: 48,
                decoration: BoxDecoration(
                  gradient: LinearGradient(colors: [accentOrange.withValues(alpha: 0.3), accentOrange.withValues(alpha: 0.1)]),
                  shape: BoxShape.circle,
                  border: Border.all(color: accentOrange.withValues(alpha: 0.3), width: 2),
                ),
                child: const Icon(Icons.account_balance_wallet_rounded, color: AppTheme.white, size: 24),
              ),
              const SizedBox(width: 10),
              Text('Balance', style: GoogleFonts.inter(fontSize: 13, color: AppTheme.white.withValues(alpha: 0.9), fontWeight: FontWeight.w500)),
              const Spacer(),
              GestureDetector(
                onTap: onAddLeadTap,
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: accentOrange.withValues(alpha: 0.3), blurRadius: 10, offset: const Offset(0, 4))],
                  ),
          ...
          Container(
            ...
            decoration: BoxDecoration(border: Border(top: BorderSide(color: AppTheme.white.withValues(alpha: 0.2), width: 1))),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('Total Earning', style: GoogleFonts.inter(fontSize: 13, color: AppTheme.white.withValues(alpha: 0.9), fontWeight: FontWeight.w500)),
  ...
  Widget _copyOfBuildSellAndEarnSection(BuildContext context, Color primary, Color accentOrange, Color primaryDark, Map<String, String> categoryPromoPaths) {
    return Column(
      ...
      children: [
        Row(
          children: [
            Expanded(child: Container(height: 1, decoration: BoxDecoration(gradient: LinearGradient(colors: [Colors.transparent, accentOrange.withValues(alpha: 0.3), Colors.transparent])))),
  ...
  static Widget _copyOfBuildKYCBanner(
    ...
    final card = Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: AppTheme.primaryText.withValues(alpha: 0.06), blurRadius: 12, offset: const Offset(0, 4))],
      ),
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: darkBlue.withValues(alpha: 0.25)),
            ),
