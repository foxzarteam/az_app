...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Future<void> _loadPaymentDetails() async {
    ...
    final user = await widget.api.getUserByMobile(mobile);
    ...
    final results = await Future.wait<dynamic>([
      widget.api.getPaymentAccounts(userId),
      widget.api.getWallet(userId),
    ]);
    ...
    if (mounted) {
      setState(() {
        ...
        _savedIfscCode = ifsc;
        if (wallet != null) {
          _balanceDisplay = _numToDisplay(wallet['balance']);
        }
      });
    }
  }
              ...
              child: ElevatedButton(
                onPressed: userId == null
                    ...
                    : () async {
                        ...
                        final ok = await api.savePaymentAccount(
                          userId!,
                          paymentType: 'upi',
                          upiId: upiId,
                        );
