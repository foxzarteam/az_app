...
class AppConstants {
  ...
  static const String hintOtpSixDigits = 'Enter 6 digit OTP here';
  static const String labelResendOtp = 'Resend OTP';
  static String otpResendCountdown(int seconds) => 'Resend in $seconds s';
  ...
  static const String msgReferralLottiePlayError =
      'refer.json could not be played.\nTry re-export from LottieFiles for mobile.';
  static const String msgReferralLottieLoadError =
...
🚀 Start your earning journey today!'''.trim();
  ...
  // Dashboard / Share — apply URLs: [AppConfig.shareApplyLinkForProduct]; banners: [AppAssets.shareBannerForProduct].
  ...
  static String get shareMessagePersonalLoan =>
      ...
      '✅ Quick Approval\n'
      '💰 Loan up to ₹5 Lakhs\n\n'
      'Apply Now : ${AppConfig.shareApplyLinkForProduct('Personal Loan')}';
  ...
  static String shareMessageForProduct(String productName) {
    final applyUrl = AppConfig.shareApplyLinkForProduct(productName);
    return 'Hello 👋\n\n'
  ...
  // Network guard overlay (above MaterialApp — use constants not inline strings)
  static const String networkOfflineTitle = 'Something went wrong';
  static const String networkOfflineBody =
      'No internet connection. Check your network and try again.';
  static const String networkTryAgain = 'Try again';
}
